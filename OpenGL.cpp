...
void OpenGL:: EnableOpenGL(HWND hWnd)
{
    ...
    _config = glm::vec4(100,100,20,20);//width height width's piece height's piece
    _vbo = generateVBO();
    _vao = generateVAO();
...
void OpenGL::paint() {
  ...
  //  glFrontFace(GL_CW);
    ...
    glm::mat4 trans(1.0f);
    glm::mat4 projection= glm::ortho(-100.0f, 100.0f, -100.0f, 100.0f, 0.0f, 500.0f);
        //glm::perspective(glm::radians(45.0f), 3.0f / 3, 0.001f, 100.0f);
  // _angle += 2;
   // glm::vec4 point(-30,-20,0,1);
  //  point = projection * point;

    glm::mat4 view = glm::lookAt(glm::vec3(0, 0.0,200.0), glm::vec3(0.0,0.0,-100.0), glm::vec3(0.0, 1.0, 0.0));
